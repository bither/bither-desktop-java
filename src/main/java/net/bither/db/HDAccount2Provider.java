...
public class HDAccount2Provider extends AbstractHDAccountProvider {
    ...
    private static HDAccount2Provider hdAccountProvider = new HDAccount2Provider(ApplicationInstanceManager.addressDBHelper);
    ...
    public HDAccount2Provider(AddressDBHelper helper) {
        this.helper = helper;
    }
