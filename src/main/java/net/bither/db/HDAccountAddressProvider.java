...
public class HDAccountAddressProvider extends AbstractHDAccountAddressProvider {
    ...
    private static HDAccountAddressProvider hdAccountAddressProvider = new HDAccountAddressProvider(ApplicationInstanceManager.txDBHelper);
    ...
    public HDAccountAddressProvider(TxDBHelper helper) {
        this.helper = helper;
    }
