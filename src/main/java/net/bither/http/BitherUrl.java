...
public class BitherUrl {
    public static final class BITHER_DNS {
        ...
        public static final String BITHER_BITCOIN = Utils.format(FOTMAT_HTTP, BITHER_BITCOIN_DOMAIN);
        public static final String BITHER_USER = Utils.format(FOTMAT_HTTP, BITHER_USER_DOMAIN);
        public static final String BITHER_STATS = Utils.format(FOTMAT_HTTP, BITHER_STATS_DOMAIN);
    ...
    //other
    public static final String BITHER_URL = "http://bither.net";
