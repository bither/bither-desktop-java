...
public class BitherTitledPanel extends JPanel {
    ...
    public BitherTitledPanel(String title, ComponentOrientation componentOrientation) {
        ...
        Font titleFont = FontSizer.INSTANCE.getAdjustedDefaultFontWithDelta(ColorAndFontConstants.BITHER_LARGE_FONT_INCREASE);
        ...
        titlePanel.add(BitherTitledPanel.getIndentPanel(preferredHeight), constraints);
        ...
        constraints.weighty = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        BitherLabel titleLabel = new BitherLabel(title, JLabel.LEFT);
    ...
    public static BitherLabel addLeftJustifiedTextAtIndent(String text, int row, JPanel panel) {
        GridBagConstraints constraints = new GridBagConstraints();
        constraints.fill = GridBagConstraints.BOTH;
        constraints.gridx = 0;
        ...
        constraints.gridheight = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        JPanel indent = BitherTitledPanel.getIndentPanel(1);
        panel.add(indent, constraints);

        BitherLabel label = new BitherLabel(text);
