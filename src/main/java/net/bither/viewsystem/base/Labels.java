...
public class Labels {
    ...
    public static JLabel newTitleLabel(MessageKey key) {
        ...
        // Font
        TitleFontDecorator.apply(label, BitherUI.BALANCE_HEADER_LARGE_FONT_SIZE);
    ...
    public static void decorateStatusLabel(JLabel statusLabel, Optional<Boolean> status) {
        ...
        if (status.isPresent()) {
            if (status.get()) {
                AwesomeDecorator.bindIcon(AwesomeIcon.CHECK, statusLabel, true, BitherUI.NORMAL_ICON_SIZE);
            } else {
                AwesomeDecorator.bindIcon(AwesomeIcon.TIMES, statusLabel, true, BitherUI.NORMAL_ICON_SIZE);
            }
        }
    ...
    public static JLabel newIconLabel(AwesomeIcon icon, Optional<MessageKey> key, Object[] values) {
        ...
        AwesomeDecorator.bindIcon(icon, label, false, BitherUI.NORMAL_ICON_SIZE);
    ...
    public static JLabel newImageLabel(BufferedImage image) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.USER, label, true, BitherUI.LARGE_ICON_SIZE);
...
//  }
    ...
    public static JLabel newSelectLanguageLabel() {
        ...
        AwesomeDecorator.applyIcon(
                ...
                label,
                true,
                BitherUI.NORMAL_PLUS_ICON_SIZE
        );
    ...
    public static JLabel newApproximately() {
        ...
        Font font = label.getFont().deriveFont(Font.BOLD, (float) BitherUI.NORMAL_ICON_SIZE);
        label.setFont(font);
...
//  }
    ...
    public static JLabel newCircle() {
        ...
        AwesomeDecorator.bindIcon(AwesomeIcon.CIRCLE, label, false, BitherUI.SMALL_ICON_SIZE);
