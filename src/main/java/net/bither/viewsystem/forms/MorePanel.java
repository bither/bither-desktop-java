...
package net.bither.viewsystem.forms;
...
import net.bither.viewsystem.forms.desktop.hdm.DesktopHDMColdPanel;
import net.bither.viewsystem.forms.desktop.hdm.DesktopHDMHotPanel;
